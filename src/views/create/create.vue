...
export default {
  ...
  methods: {
    ...
    send() {
      ...
      const mockData = {
        title:this.backData.title,
        property: this.backData.property,
        classify: this.backData.classify,
        product_pic_url:
          this.backData.product_pic_url,
        product_story: this.backData.product_story,
        raw_material: this.backData.raw_material,
        steps: this.backData.steps,
        skill: this.skill,
      };
